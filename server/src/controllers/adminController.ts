...
export class AdminController {
  ...
  public static async triggerScrapeRun(req: Request, res: Response): Promise<void> {
    try {
  ...
  public static async getScrapeRunById(req: Request, res: Response): Promise<void> {
    try {
  ...
  public static async listScrapeRuns(req: Request, res: Response): Promise<void> {
    try {
  ...
  public static async triggerSingleSource(req: Request, res: Response): Promise<void> {
    try {
