...
export class RouteController {
  ...
  static async getRouteDossier(req, res) {
    try {
  ...
  static async compareRoutes(req, res) {
    try {
      const r1Code = (req.query.route1 || 'DEL-BOM').toUpperCase();
      const r2Code = (req.query.route2 || 'DEL-BLR').toUpperCase();
      const mode = req.query.mode === 'LIVE' ? 'LIVE' : 'DEMO';
