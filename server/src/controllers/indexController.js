...
export class IndexController {
  static async getNationalIndex(req, res) {
    try {
  ...
  static async getRouteIndex(req, res) {
    try {
  ...
  static async getHeatmapMatrix(req, res) {
    try {
      const mode = req.query.mode === 'LIVE' ? 'LIVE' : 'DEMO';
  ...
  static async getLeadTimeCurve(req, res) {
    try {
      const routeCode = (req.query.route || 'DEL-BOM').toUpperCase();
      const mode = req.query.mode === 'LIVE' ? 'LIVE' : 'DEMO';
