import { IQuote } from '../models/Quote.js';

export interface ICleanedResult {
  cleanedId: string;
  rawQuoteId: string;
  mode: 'LIVE' | 'DEMO';
  routeCode: string;
...
export class CleanerService {
   ...
   */
  public static deduplicateMultiOTA(quotes: any[]): { retained: any[]; dropped: any[] } {
   ...
   */
  public static filterOutliersMAD(fares: number[], threshold = 3.0): boolean[] {
   ...
   */
  public static cleanQuotesBatch(rawQuotes: any[]): ICleanedResult[] {
   ...
   */
  public static validateQuote(quote: any): { isValid: boolean; reason?: string } {
