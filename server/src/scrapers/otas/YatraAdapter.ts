...
export class YatraAdapter extends ScraperBase {
  public sourceName = 'Yatra';
  public sourceType = 'OTA' as const;
  public portalUrl = 'https://www.yatra.com';
  ...
  public async searchFlights(params: ISearchParams): Promise<IRawQuoteExtracted[]> {
    ...
    try {
      ...
      await page.goto(`${this.portalUrl}/domestic-flights/`, { waitUntil: 'domcontentloaded' }).catch(() => null);
      await page.close();
      await context.close();
      return [];
    } catch {
