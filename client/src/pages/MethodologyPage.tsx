    ...
    <div style={{ paddingBottom: '50px' }}>
      ...
      <div style={{ padding: '24px 28px', maxWidth: '1100px' }}>
        ...
        >
          ...
          <p style={{ fontSize: '13.5px', color: 'var(--text-main)', lineHeight: '1.7' }}>
            VayuSutra APIx is designed for high-frequency augmentation of the official Consumer Price Index (CPI) compiled by the National Statistical Office (NSO), Ministry of Statistics & Programme Implementation (MoSPI).
            ...
            VayuSutra resolves this using an unweighted geometric mean of price relatives at the elementary level (<strong>Short-Jevons Index</strong>), structured across <strong>5 standardized advance booking horizons</strong>, chained daily [I(t) = I(t-1) &times; J(t)], and weighted by empirical Directorate General of Civil Aviation (DGCA) scheduled passenger traffic.
          </p>
        </div>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {/* 1. Elementary Level */}
            <div style={{ backgroundColor: '#080D1D', border: '1px solid var(--border)', borderRadius: '10px', padding: '18px' }}>
              ...
              <div style={{ fontSize: '11.5px', color: 'var(--text-sub)', marginTop: '8px' }}>
            ...
            <div style={{ backgroundColor: '#080D1D', border: '1px solid var(--border)', borderRadius: '10px', padding: '18px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', marginTop: '10px', fontSize: '11.5px', color: 'var(--text-sub)', flexWrap: 'wrap' }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div style={{ backgroundColor: '#080D1D', padding: '14px', borderRadius: '8px' }}>
              <div style={{ fontWeight: 700, color: '#FFFFFF', marginBottom: '6px' }}>Outlier Rejection (IQR & Hampel)</div>
            ...
            <div style={{ backgroundColor: '#080D1D', padding: '14px', borderRadius: '8px' }}>
              <div style={{ fontWeight: 700, color: '#FFFFFF', marginBottom: '6px' }}>Seat Class Harmonization</div>
              <p style={{ fontSize: '12px', color: 'var(--text-muted)', lineHeight: '1.5' }}>
            ...
            <div style={{ backgroundColor: '#080D1D', padding: '14px', borderRadius: '8px' }}>
              <div style={{ fontWeight: 700, color: '#FFFFFF', marginBottom: '6px' }}>All-Inclusive Price Definition</div>
              <p style={{ fontSize: '12px', color: 'var(--text-muted)', lineHeight: '1.5' }}>
            ...
            <div style={{ backgroundColor: '#080D1D', padding: '14px', borderRadius: '8px' }}>
              <div style={{ fontWeight: 700, color: '#FFFFFF', marginBottom: '6px' }}>Cryptographic SHA-256 Immutability</div>
              <p style={{ fontSize: '12px', color: 'var(--text-muted)', lineHeight: '1.5' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
            ...
            <h4 style={{ fontSize: '14px', fontWeight: 800, color: '#FCA5A5', margin: 0 }}>
              Methodological Limitations & Statutory Disclaimers
            </h4>
          </div>
          <ul style={{ fontSize: '12.5px', color: 'var(--text-main)', lineHeight: '1.6', paddingLeft: '20px' }}>
            <li>
            ...
            <li>
              <strong>Non-Endorsement:</strong> VayuSutra is an independent technological research prototype developed for Smart India Hackathon 2026 and does not represent an official index released by the Government of India or MoSPI.
            </li>
          </ul>
        </div>
      </div>
