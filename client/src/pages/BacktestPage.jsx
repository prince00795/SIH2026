  ...
  return (
    <div style={{ paddingBottom: '40px' }}>
      ...
      <div style={{ padding: '24px 28px' }}>
        ...
        >
          <AlertCircle size={24} color="#B45309" style={{ flexShrink: 0, marginTop: '2px' }} />
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
              <h2 style={{ fontSize: '15px', fontWeight: 800, color: '#92400E', margin: 0 }}>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-muted)', lineHeight: '1.6' }}>
              ...
              <strong> Aerostat does NOT fabricate backtest numbers, Pearson correlation coefficients (r), or R² metrics</strong>.
            ...
            <div style={{ marginTop: '8px', fontSize: '12.5px', color: '#B45309', fontWeight: 500 }}>
        ...
        >
          <KPICard
            ...
            changeType="neutral"
            badge="UNAVAILABLE"
            icon={<BarChart2 size={18} color="var(--text-sub)" />}
          ...
          <KPICard
            ...
            changeType="neutral"
            badge="UNAVAILABLE"
            icon={<Clock size={18} color="var(--text-sub)" />}
          ...
          <KPICard
            ...
            changeType="neutral"
            badge="UNAVAILABLE"
            icon={<FileCheck size={18} color="var(--text-sub)" />}
          ...
          <KPICard
            ...
            icon={<Database size={18} color="#15803D" />}
        ...
        >
          <h3 style={{ fontSize: '15px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '10px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div style={{ backgroundColor: '#F9FAFB', border: '1px solid var(--border)', borderRadius: '6px', padding: '16px' }}>
              ...
              <div className="mono" style={{ fontSize: '12px', color: '#2563EB', marginBottom: '8px', backgroundColor: '#FFFFFF', padding: '6px 10px', borderRadius: '4px', border: '1px solid #E5E7EB' }}>
                r = Σ(X - X̄)(Y - Ȳ) / [√Σ(X - X̄)² √Σ(Y - Ȳ)²]
              </div>
              <p style={{ fontSize: '12px', color: 'var(--text-sub)', lineHeight: '1.5' }}>
                Evaluates linear co-movement between monthly aggregated Aerostat APIx and MoSPI Airfare CPI (Item <code>07.3.3.1.2.01</code>).
                Statutory acceptance criterion: r ≥ 0.85 at p &lt; 0.01.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: '#F9FAFB', border: '1px solid var(--border)', borderRadius: '6px', padding: '16px' }}>
              ...
              <div className="mono" style={{ fontSize: '12px', color: '#15803D', marginBottom: '8px', backgroundColor: '#FFFFFF', padding: '6px 10px', borderRadius: '4px', border: '1px solid #E5E7EB' }}>
                MAPE = (1 / n) * Σ |(CPI_i - APIx_i) / CPI_i| * 100%
              </div>
              <p style={{ fontSize: '12px', color: 'var(--text-sub)', lineHeight: '1.5' }}>
                Measures absolute point divergence after common-base re-indexing.
                A target MAPE ≤ 4.5% ensures that high-frequency daily nowcasts do not introduce systematic bias.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: '#F9FAFB', border: '1px solid var(--border)', borderRadius: '6px', padding: '16px' }}>
              ...
              <p style={{ fontSize: '12px', color: 'var(--text-sub)', lineHeight: '1.5' }}>
                ...
                This validates whether Aerostat serves as a genuine leading indicator for monetary policy.
              </p>
            </div>
